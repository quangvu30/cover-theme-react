...
import { getProfile } from "@/helpers/backend_request";
            ...
            <Row className="g-4">
              ...
              <Col>
                <div className="p-2">
                  ...
                  <p className="text-white-75">{userData?.role}</p>
                  <div className="hstack text-white-50 gap-1">
                    ...
                    <div>
                      <i className="ri-building-line me-1 text-white-75 fs-16 align-bottom"></i>
                      Themesbrand
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div className="d-flex">
                  ...
                  <div className="flex-shrink-0">
                    <Link href="/Profile/Settings" className="btn btn-success">
                                                                            ...
                                                                            <div className="d-flex">
                                                                                <div
                                                                                    ...
                                                                                    <h5 className="fs-14 text-truncate mb-1">
                                                                                        <Link href="#" className="text-dark">Client - John</Link></h5>
                                                                                    <p className="text-muted text-truncate mb-0">
                                                                                        Last Update : <span
                                                                        ...
                                                                        <CardBody className="p-4">
                                                                            <div className="d-flex">
                                                                                <div
                                                                                    ...
                                                                                    <h5
                                                                                        className="fs-14 text-truncate mb-1">
                                                                                        <Link href="#" className="text-dark">Brand logo Design</Link></h5>
                                                                                    <p className="text-muted text-truncate mb-0">
                                                                                        Last Update : <span
                                                                        ...
                                                                        <CardBody className="p-4">
                                                                            <div className="d-flex">
                                                                                <div className="flex-grow-1 text-muted overflow-hidden">
                                                                                    <h5 className="fs-14 text-truncate mb-1">
                                                                                        <Link href="#" className="text-dark">Chat App</Link></h5>
                                                                                    <p
                                                                                        className="text-muted text-truncate mb-0">
                                                                                        Last Update : <span
                                                                                            className="fw-semibold text-dark">1
                        ...
                        <div className="acitivity-timeline">
                          ...
                          <div className="acitivity-item py-3 d-flex">
                            ...
                            <div className="flex-grow-1 ms-3">
                              <h6 className="mb-1">
                                Your order is placed{" "}
                                <span className="badge badge-soft-success align-middle">
                                  Out of Delivery
                                </span>
                              </h6>
                              <p className="text-muted mb-2">
                              ...
                              >
                                <CardBody className="p-4">
                                  <div className="d-flex">
                                    ...
                                    <div className="flex-shrink-0 ms-2">
                                      <div
                                        className={`badge badge-soft-${item.badgeClass} fs-12`}
                                      >
                                        {item.badgeText}
                                      </div>
                                    </div>
